...
<div id="right">
	...
	<div id="rightBody">
		...
		<!-- 회원 상세보기 페이지 -->
		<form id="frmDetail" action="member_detail.do">
			<input type="hidden" id="ud" name="userId" value=""/>
		</form>
		...
		<div style="margin: 10px; text-align: center;">
			...
			<table class="table tableList">
				...
				<tr id="top_title">
					...
					<th style="width:200px; border-bottom: 1px solid #E5E5E5;">아이디</th>
					<th style="width:200px; border-bottom: 1px solid #E5E5E5;">닉네임</th>
					<th style="width:200px; border-bottom: 1px solid #E5E5E5;">전화번호</th>
					<th style="width:200px; border-bottom: 1px solid #E5E5E5;">가입일</th>
					<th style="width:200px; border-bottom: 1px solid #E5E5E5;">회원상태</th>
				</tr>
				</thead>
