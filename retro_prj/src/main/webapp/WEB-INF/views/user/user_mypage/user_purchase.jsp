			...
			<div class="w-full flex-grow">
				...
				<div class="px-0 max-lg:mt-10">
					<div
						...
						<div
							class="flex-shrink-0 mb-1 text-xs leading-4 text-body md:text-sm pe-4 md:me-6 lg:ps-2 lg:block">2
							개의 상품</div>
						<div class="flex flex-wrap items-center justify-between">
							<div class="mr-0 lg:mr-4">
								<ul class="colors flex flex-nowrap -me-3">
									...
									<li
										class="shrink-0 cursor-pointer rounded-full border border-gray-100  p-1 px-2 mr-1 sm:mr-3 flex justify-center items-center text-heading text-xs md:text-sm uppercase font-semibold transition duration-200 ease-in-out hover:border-black">예약중</li>
									<li
					...
					<div
						...
						<div class="relative">
							<a
								...
								title="그로브스토어 니트" href="/product/141110450"><div
									class="relative w-full rounded-md overflow-hidden pt-[100%] mb-3 md:mb-3.5">
									<img alt="그로브스토어 니트" referrerpolicy="no-referrer"
										src="https://img2.joongna.com/media/original/2023/11/12/1699773571021gWB_kr0Qp.jpeg?impolicy=thumb&amp;size=150"
									...
									<div
										class="absolute top-0 left-0 flex items-end w-full h-full bg-black bg-opacity-50">
										<div
											class="w-full p-2 text-center text-white bg-black bg-opacity-50">판매완료</div>
									</div>
								</div>
								<div class="w-full overflow-hidden p-2 md:px-2.5 xl:px-4">
									<h2 class="line-clamp-2 text-sm md:text-base text-heading">그로브스토어
										니트</h2>
									<div
										class="font-semibold space-s-2 mt-0.5 text-heading lg:text-lg lg:mt-1.5">1,000원</div>
									<div class="my-1">
										<span class="text-sm text-gray-400">역삼1동</span><span
											class="text-sm text-gray-400 mx-1">|</span><span
											class="text-sm text-gray-400">16일 전</span>
									</div>
							...
							<svg stroke="currentColor" fill="currentColor" stroke-width="0"
								viewBox="0 0 16 16"
								class="absolute w-6 h-6 cursor-pointer right-2 bottom-8"
						...
						<div class="relative">
							<a
								class="group box-border overflow-hidden flex rounded-md cursor-pointer pe-0 pb-2 lg:pb-3 flex-col items-start transition duration-200 ease-in-out transform hover:-translate-y-1 md:hover:-translate-y-1.5 hover:shadow-product bg-white"
								title="그로브스토어 니트" href="/product/140928124"><div
									class="relative w-full rounded-md overflow-hidden pt-[100%] mb-3 md:mb-3.5">
									<img alt="그로브스토어 니트" referrerpolicy="no-referrer"
										src="https://img2.joongna.com/media/original/2023/11/12/1699773571021gWB_kr0Qp.jpeg?impolicy=thumb&amp;size=150"
										decoding="async" data-nimg="fill"
								...
								<div class="w-full overflow-hidden p-2 md:px-2.5 xl:px-4">
									...
									<div class="my-1">
										<span class="text-sm text-gray-400">역삼1동</span><span
											class="text-sm text-gray-400 mx-1">|</span><span
											class="text-sm text-gray-400">18일 전</span>
									</div>
									<div class="flex items-center">
										<svg width="30" height="17" viewBox="0 0 30 17" fill="none"
											xmlns="http://www.w3.org/2000/svg" class="mr-1">
