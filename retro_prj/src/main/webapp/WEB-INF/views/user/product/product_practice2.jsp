		...
		<div
			...
			<div
						...
						<div class="swiper-wrapper"
							...
							<div class="swiper-slide swiper-slide-active"
								...
								<div
									...
									<img alt="그림 그려 드림--0" referrerpolicy="no-referrer"
										src="https://img2.joongna.com/media/original/2023/12/01/1701419494686m1y_jgM29.png?impolicy=resizeWatermark3&amp;ftext=zxxxdsdd"
							...
							<div class="swiper-slide swiper-slide-next" style="width: 612px;">
								<div
									class="col-span-1 transition duration-150 ease-in hover:opacity-90 w-full relative pt-[100%]">
									<img alt="그림 그려 드림--1" referrerpolicy="no-referrer"
										src="https://img2.joongna.com/media/original/2023/12/01/1701419500871FbS_6MFNX.png?impolicy=resizeWatermark3&amp;ftext=zxxxdsdd"
										decoding="async" data-nimg="fill"
										class="object-cover w-full h-full rounded-lg top-1/2 left-1/2"
										loading="lazy"
										style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
				...
				<div class="pt-4 lg:pt-0">
					...
					<div class="pb-5 border-b border-gray-300">
						...
						<a
							href="/search-price/%EA%B7%B8%EB%A6%BC%20%EA%B7%B8%EB%A0%A4%20%EB%93%9C%EB%A6%BC?seq=144045526&amp;actionDetailType=MARKET_PRICE_PRODUCT_DETAIL"><span
					...
					<div class="py-4 border-b border-gray-300 space-s-4">
						<div class="pb-1 space-y-5 text-sm">
							<div class="flex justify-between text-body">
								<span>8초 전 · 조회 0 · 찜 0</span><a href="/fraud"><div
								...
								<div class="flex pb-2">
									...
									<div>
										<button class="flex items-center">
											<div class="text-left">
												<span class="font-semibold">CU 알뜰택배 할인 혜택</span><span>
													외 2건</span>
											</div>
								...
								<div class="flex">
									...
									<div>
										<a class="font-semibold"
											href="https://web.joongna.com/event/detail/1136">1만원 이상
											무이자 할부<span
						...
						<ul class="flex flex-row justify-around w-full">
							<li><button class="flex flex-col items-center">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
										...
										<rect x="4.25" y="4" width="1.5" height="1" rx="0.5"
											fill="#141313"></rect>
										<rect x="4.25" y="6" width="1.5" height="1" rx="0.5"
											fill="#141313"></rect>
										<path d="M15 7L18 4L21 7" stroke="#141313" stroke-width="1.5"
											stroke-linecap="round" stroke-linejoin="round"></path></svg>
									<p class="text-sm mt-[6px]">위로 올리기</p>
								</button></li>
							<li><button class="flex flex-col items-center">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
										xmlns="http://www.w3.org/2000/svg">
			...
			<div class="block grid-cols-5 lg:grid lg:mb-10">
				<div name="product-description"
					...
					<article>
						<p
							class="px-4 py-10 break-words break-all whitespace-pre-line lg:py-2">-나의
							재능을 나누고 싶어서</p>
					</article>
				</div>
				<div name="product-store"
					...
					<div class="flex">
						<div class="flex w-full flex-col justify-around lg:ml-4">
							<a class="font-semibold text-base text-jnblack"
								...
								class="font-medium text-sm flex text-jnGray-500">판매상품 0 ·
								안전거래 0 · 후기 0</span>
						</div>
					...
					<div class="lg:ml-4">
						<div class="flex justify-between mt-2 text-[#0CB650] font-medium">
							<strong>신뢰지수 267</strong><span class="text-jnGray-500 text-sm">1,000</span>
						</div>
						<div class="w-full h-1.5 bg-[#CCF4DC] rounded overflow-hidden">
							<div class="h-full rounded bg-[#0DCC5A]" style="width: 26.7%;"></div>
						</div>
					</div>
					<div class="pt-5"></div>
				</div>
