...
<div style=" font-size:  25px; font-weight: bold; color: #333333;  margin-top: 150px; text-align: center; margin-bottom: 150px "><c:out value="${cnt eq 0 ? '문의 수정이 실패하였습니다. 다시 시도해주세요': '문의 수정이 완료되었습니다.' }"/></div>
